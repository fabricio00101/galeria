...
## Descripción
Este proyecto es una práctica para crear una galería de imágenes en un sitio web estático. La idea fue practicar la organización de imágenes, el uso de CSS para estilos y la estructuración de un sitio visualmente atractivo con efectos hover.
...
1. Clonar el repositorio:  
   ```bash
   git clone https://github.com/fabricio00101/galeria.git
